...
mit einer fortlaufenden Zahl ergänzt wird.
...
Überschneiden sich die Bereiche, ist die Angabe
\hyperlink{anteilspezialmodus}{AnteilSpezialModus}
erforderlich.

Diese Daten werden bei jedem Anwendungsstart ausgewertet und die jeweiligen
Anteile neu berechnet.
...
\item erweiterter Ablauf beim Datenaustausch:
  \begin{itemize}
  \item Meldung an den Benutzer (konfigurierbar) mit Ok+Abbrechen (z.B. bitte
    Diskette einlegen)
