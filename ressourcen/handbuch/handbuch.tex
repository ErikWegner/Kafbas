...
die Eingabe zum Feld \gdq{Artikelpreis}. Haben Sie sich vertippt, können Sie
...
soll, muss die Funktion \gdq{Datenaustausch einlesen} aufgerufen werden. Dabei
...
letzten Spalte. Die erste Spalte weist durch die Ausschrift \gdq{Summe} darauf
...
Ändernrechte.\index{Rechte|see{Berechtigungen}} \index{Berechtigung}
\index{Schreibrechte|see{Berechtigungen}}
\index{Ändernrechte|see{Berechtigungen}}
...
Als Datenbank wird die komplett in Java programmierte
\href{http://db.apache.org/derby}{Derby-Datenbank} aus dem
\href{http://www.apache.org}{Apache-Projekt} eingesetzt.
...
größer sein als der Wert für \gdq{AnzahlKassen}.
