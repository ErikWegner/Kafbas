@SET MINLIB=lib/log4j.jar;lib/derby.jar;lib/derbyLocale_de_DE.jar;lib/BareBonesBrowserLaunch.jar
...
java -Dswing.defaultlaf=com.sun.java.swing.plaf.windows.WindowsLookAndFeel -cp %MINLIB%;%APPJAR%;%OPTLIB%;dist/kafbas.jar de.ewus.kafbas.Kafbas
